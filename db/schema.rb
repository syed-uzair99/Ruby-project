...
ActiveRecord::Schema[7.0].define(version: 2022_05_06_114451) do
...
# Could not dump table "sale_details" because of following StandardError
#   Unknown type 'STRING' for column 'CustomerName'
